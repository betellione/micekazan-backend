...
namespace WebApp1.Data.Migrations
{
    ...
    [Migration("20240215071431_IndexesInTicket")]
    partial class IndexesInTicket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp1.Models.Client", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("Client_Email_ix");

                    b.HasIndex("ForeignId")
                        .IsUnique()
                        .HasDatabaseName("Client_ForeignId_ix");
            ...
            modelBuilder.Entity("WebApp1.Models.Ticket", b =>
                {
                    ...
                    b.HasIndex("Barcode")
                        .HasDatabaseName("Ticket_Barcode_ix");
                    ...
                    b.HasIndex("ForeignId")
                        .HasDatabaseName("Ticket_ForeignId_ix");
